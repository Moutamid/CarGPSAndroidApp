...
public class VehicleInfoListAdapter extends RecyclerView.Adapter<VehicleInfoListAdapter.PositionViewHolder> implements Filterable {

    private Context mContext;
    private ArrayList<CarDetails> positionArrayList;
    private ItemPressListener itemPressListener;

    public VehicleInfoListAdapter(Context mContext, ArrayList<CarDetails> positionArrayList) {
